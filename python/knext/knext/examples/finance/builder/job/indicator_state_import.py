...
class IndicatorState(BuilderJob):
    def build(self):
        source = CSVReader(
            local_path="./builder/job/data/indicator_state_edges.csv",
            columns=["id1", "rel", "id2"],
            start_row=2,
        )
        ...
        state_mapping = (
            ...
            .add_relation_mapping("id2", "derivedFrom", Finance.Indicator, LinkingStrategyEnum.IDEquals)
        )
